...
int main(void) {
  ...
  3e:	89 c6                	mov    %eax,%esi
	struct wmapinfo *wminfo = malloc(sizeof(struct wmapinfo));
  40:	e8 3b 06 00 00       	call   680 <malloc>
	getwmapinfo(wminfo);
  45:	89 04 24             	mov    %eax,(%esp)
	struct wmapinfo *wminfo = malloc(sizeof(struct wmapinfo));
  48:	89 c3                	mov    %eax,%ebx
	getwmapinfo(wminfo);
  4a:	e8 44 03 00 00       	call   393 <getwmapinfo>
	printf(1, "total_mmaps %d\n", wminfo->total_mmaps);
  4f:	83 c4 0c             	add    $0xc,%esp
  52:	ff 33                	push   (%ebx)
  54:	68 78 07 00 00       	push   $0x778
  59:	6a 01                	push   $0x1
  5b:	e8 f0 03 00 00       	call   450 <printf>
	wunmap(test);
  60:	89 34 24             	mov    %esi,(%esp)
  63:	e8 13 03 00 00       	call   37b <wunmap>
	wunmap(0x60000000);
  68:	c7 04 24 00 00 00 60 	movl   $0x60000000,(%esp)
  6f:	e8 07 03 00 00       	call   37b <wunmap>
