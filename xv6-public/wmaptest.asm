...
int main(void) {
  ...
  27:	e8 2f 03 00 00       	call   35b <wunmap>
	wmap(0x60001000, 8192, MAP_FIXED | MAP_SHARED | MAP_ANONYMOUS, -1);
  2c:	6a ff                	push   $0xffffffff
  2e:	6a 0e                	push   $0xe
  30:	68 00 20 00 00       	push   $0x2000
  35:	68 00 10 00 60       	push   $0x60001000
  3a:	e8 14 03 00 00       	call   353 <wmap>
	wunmap(0x60001000);
  3f:	83 c4 14             	add    $0x14,%esp
  42:	68 00 10 00 60       	push   $0x60001000
  47:	e8 0f 03 00 00       	call   35b <wunmap>
	exit();
  4c:	e8 62 02 00 00       	call   2b3 <exit>
  51:	66 90                	xchg   %ax,%ax
  53:	66 90                	xchg   %ax,%ax
  55:	66 90                	xchg   %ax,%ax
  57:	66 90                	xchg   %ax,%ax
