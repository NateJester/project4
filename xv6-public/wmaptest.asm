...
_wmaptest:     file format elf32-i386
...
int main(void) {
  ...
  1c:	68 00 00 00 60       	push   $0x60000000
  21:	e8 6d 03 00 00       	call   393 <wmap>
	uint test = wmap(0, 4096, MAP_SHARED | MAP_ANONYMOUS, -1);
  26:	6a ff                	push   $0xffffffff
  28:	6a 06                	push   $0x6
  2a:	68 00 10 00 00       	push   $0x1000
  2f:	6a 00                	push   $0x0
  31:	e8 5d 03 00 00       	call   393 <wmap>
	struct wmapinfo *wminfo = malloc(sizeof(struct wmapinfo));
  36:	83 c4 14             	add    $0x14,%esp
  39:	68 c4 00 00 00       	push   $0xc4
	uint test = wmap(0, 4096, MAP_SHARED | MAP_ANONYMOUS, -1);
  3e:	89 c6                	mov    %eax,%esi
	struct wmapinfo *wminfo = malloc(sizeof(struct wmapinfo));
  40:	e8 5b 06 00 00       	call   6a0 <malloc>
	getwmapinfo(wminfo);
  45:	89 04 24             	mov    %eax,(%esp)
	struct wmapinfo *wminfo = malloc(sizeof(struct wmapinfo));
  48:	89 c3                	mov    %eax,%ebx
	getwmapinfo(wminfo);
  4a:	e8 64 03 00 00       	call   3b3 <getwmapinfo>
  ...
  63:	e8 33 03 00 00       	call   39b <wunmap>
	printf(1, "first unmap worked :)\n");
  68:	58                   	pop    %eax
  69:	5a                   	pop    %edx
  ...
  71:	e8 fa 03 00 00       	call   470 <printf>
	wunmap(0x60000000);
  76:	c7 04 24 00 00 00 60 	movl   $0x60000000,(%esp)
  7d:	e8 19 03 00 00       	call   39b <wunmap>
	printf(1, "second test also worked:)\n");
  82:	59                   	pop    %ecx
  83:	5b                   	pop    %ebx
  84:	68 bf 07 00 00       	push   $0x7bf
  89:	6a 01                	push   $0x1
  8b:	e8 e0 03 00 00       	call   470 <printf>
	exit();
  90:	e8 5e 02 00 00       	call   2f3 <exit>
  95:	66 90                	xchg   %ax,%ax
  97:	66 90                	xchg   %ax,%ax
  99:	66 90                	xchg   %ax,%ax
  9b:	66 90                	xchg   %ax,%ax
 ...
 3cc:	89 d1                	mov    %edx,%ecx
{
 ...
 3f9:	0f b6 92 3c 08 00 00 	movzbl 0x83c(%edx),%edx
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 e4 07 00 00 	jmp    *0x7e4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba da 07 00 00       	mov    $0x7da,%edx
        while(*s != 0){
 ...
 611:	a1 ec 0a 00 00       	mov    0xaec,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 ec 0a 00 00    	mov    %edx,0xaec
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 ec 0a 00 00    	mov    %edx,0xaec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d ec 0a 00 00    	mov    0xaec,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d ec 0a 00 00    	mov    0xaec,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 ec 0a 00 00    	mov    0xaec,%edx
 ...
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf f0 0a 00 00       	mov    $0xaf0,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 f4 0a 00 00 00 	movl   $0x0,0xaf4
 782:	00 00 00 
    if(p->s.size >= nunits){
