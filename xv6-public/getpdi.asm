...
_getpdi:     file format elf32-i386
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba b3 07 00 00       	mov    $0x7b3,%edx
        while(*s != 0){
